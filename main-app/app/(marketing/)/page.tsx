...
import { ShieldCheck, EyeOff, Zap, ArrowRight, Shield, Lock, Globe, Ghost } from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {/* Trust Section */}
      <section className="w-full py-24 px-4 max-w-4xl mx-auto text-center space-y-12">
        <div className="space-y-4">
          <h2 className="text-3xl font-black uppercase tracking-tighter italic">Non-Custodial by Design</h2>
          <p className="text-muted-foreground leading-relaxed">
